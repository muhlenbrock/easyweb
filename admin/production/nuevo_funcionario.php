...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <form>
                        ...
                        <button id="btnSave" type="submit" class="btn btn-success pull-right submit"> Crear Funcionario </button>
    ...
    <!--Custom JS-->
    <script src="js/custom/nuevo_funcionario.js" type="text/javascript"></script>
