...
<body class="nav-md">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="text-center">
                                <a type="button" href="calendario.php" class="btn btn-info crearevento"><span><i class="fa fa-pencil-square-o fa-2x center"></i></span> <span>Crear Evento</span> </a>
                            </div>
                            <div class="table-responsive">
                                <table id="datatable-keytable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Nombre Evento</th> <!-- Titulo -->
                                            <th>Fecha Inicio</th> <!-- Bajada -->
                                            <th>Fecha Fin</th> <!-- Imagen -->
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable-keytable').DataTable({
            ...
            ajax: "../controllers/listar_evento.php",
            deferRender: true,
            scrollY: 380,
            scrollCollapse: true,
            keys: true,
        ...
        function eliminarEvento($id){
            if (confirm("Estas a punto de eliminar una noticia ¿Estás Seguro?")) {
                $.post('../controllers/eliminar_evento.php', {id: $id}, function(data){
                     table.ajax.reload();
                }).done(function(data){
                    new PNotify({
                        title: data,
