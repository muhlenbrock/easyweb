                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="text-center">
                                <a type="button" href="nuevo_docente.php" class="btn btn-info creardocente"><span><i class="fa fa-pencil-square-o fa-2x center"></i></span> <span>Crear Docente</span> </a>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function eliminarCuerpo($id){
            if (confirm("Estas a punto de eliminar una noticia ¿Estás Seguro?")) {
                $.post('../routes/eliminar_cuerpo.php', {id: $id}, function(data){
                     table.ajax.reload();
                }).done(function(data){
                    new PNotify({
                        title: data,
