...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <form>
                        ...
                        <button id="btnSave" type="submit" class="btn btn-success pull-right"> Actualizar Funcionario </button>
    ...
    <script src="../src/js/dropzone-funcionario.js" type="text/javascript"></script>
    <!-- PNotify -->
    ...
    <script src="js/custom/editar_funcionario.js" type="text/javascript"></script>
